<script setup>
import BackgroundAnimationVue from './components/BackgroundAnimation.vue'
...
<template>
  <main class="w-100 min-w-full h-screen min-h-full px-4 py-2 grid place-items-center overflow-x-hidden">
